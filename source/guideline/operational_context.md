...
The service described in this specification defines the exchange of enhanced AtoN information using S-201 between a service provider and the end-user of such a service. In the most common case, according to the IALA interpretation of the IMO *MS-2 Aids to Navigation* maritime service [@cite:iala-ms2], as illustrated in [@fig:ms_aton_information_flow], the end user will be a member of staff of another Lighthouse Authority or a Hydrographic Office. It may also be used to harmonise the exchange of AtoN information between the various stakeholders in the data distribution chain before it is propagated towards the mariners. This includes the data exchange between AtoN Authorities, coastal authorities and Regional Electronic Navigational Chart Coordination Centre (RENCs).

Depending on the specific requirements, the service usage patterns may differ. For example, a Hydrographic Office could pull all available data and subscribe to updates from a data producer (e.g. national AtoN authority) and redistribute the data to the RENCs via S-101 and S-125 (after applying validation checks or optimising the data for a specific group of end-users). The orchestration of multiple AtoN information services in the distribution chain, however, is not in the scope of this document and lies within the responsibility of the service provider(s).
...
The S-201 data should be discoverable only by Hydrographic Offices, Coastal State Authorities and other relevant organisations. S-201 data should enhance S-101 ENC, S-124 NW and S-125 AtoN digital services, especially by reducing the effort in the transformation of data, with the harmonization of data models. This could be accomplished by introducing efficient data exchange mechanism between authorities.
